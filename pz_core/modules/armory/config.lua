Armory_Config = {
    ...
    items = {
        ...
        {item = "weapon_knife", label = "Couteau",price = 7500, isItem = false},
        {item = "WEAPON_SWITCHBLADE", label = "Cran d'arrêt",price = 10000, isItem = false},
        {item = "weapon_bat", label = "Batte",price = 5000, isItem = false},
        {item = "weapon_golfclub", label = "Club de Golf",price = 4500, isItem = false},
        {category = "↓ ~r~Armes de poing ~s~↓"},
        {item = "weapon_snspistol", label = "Pistolet Pétoire",price = 75000, isItem = false},
    },
