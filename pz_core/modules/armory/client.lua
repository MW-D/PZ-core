...
local function init()
    ...
    local blip = AddBlipForCoord(817.40, -2161.86, 29.61)
...
trainingConfing.vectors = {
    vector3(818.27, -2181.29, 29.61), vector3(821.03, -2175.97, 29.61), vector3(818.44, -2169.19, 29.61),

    vector3(824.12, -2181.70, 29.61), vector3(821.884, -2183.82, 29.61), vector3(824.49, -2168.35, 29.61),

    vector3(824.31, -2174.82, 29.61), vector3(825.71, -2187.29, 29.61), vector3(825.41, -2177.14, 29.61),

    vector3(817.68, -2172.97, 29.61), vector3(817.53, -2188.16, 29.61), vector3(817.20, -2178.07, 29.61)
}
...
local function initTraining()
    ...
    Citizen.CreateThread(function()
        while currentlyTraining and trainingConfing.killed <= trainingConfing.total and trainingConfing.count <= trainingConfing.total do
            ...
            trainingConfing.ped = CreatePed(9, ped, pos.x, pos.y, pos.z, 355.30, false, false)
