    ...
    groups = {
        ["ltd"] = {
            ...
            items = {
                ...
                [2] = {item = "soda", label = "Soda", price = 35, maxQty = 20},
                [3] = {item = "coffe", label = "Café", price = 30, maxQty = 20},
                [4] = {item = "water", label = "Eau Pétillante", price = 25, maxQty = 20},
                [5] = {category = "↓ ~b~Aliments ~s~↓"},
                [6] = {item = "sandwich", label = "Sandwich", price = 35, maxQty = 20},
                [7] = {item = "chips", label = "Paquet de Chips", price = 30, maxQty = 20},
                [8] = {item = "saucisson", label = "Saucisson sec", price = 25, maxQty = 20},
                [9] = {category = "↓ ~b~Éléctronique  ~s~↓"},
                [10] = {item = "phone", label = "Téléphone", price = 500, maxQty = 5},
                [11] = {item = "sim_card", label = "Carte sim", price = 200, maxQty = 5}
