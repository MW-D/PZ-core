    ...
    Citizen.CreateThread(function()
        ...
        while dist < 1.5 and not closed do
            ...
            RageUI.IsVisible(RMenu:Get("pz_core_inv",'pz_core_inv_take'),true,true,true,function()
                ...
                RageUI.List("Quatité(s) à prendre : ~s~", qty, selectedQty, nil, {}, selectedQty <= itemsSelected.count, function(Hovered, Active, Selected, Index) selectedQty = Index end)
            ...
            RageUI.IsVisible(RMenu:Get("pz_core_inv",'pz_core_inv_deposit'),true,true,true,function()
                ...
                if count == 0 then
                    RageUI.Separator("")
                    RageUI.Separator("~r~Vous ne possédez aucun item sur vous.")
                    RageUI.Separator("")
                end
